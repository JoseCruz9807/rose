...
_lr_productions = [
  ...
  ('rose -> PROGRAM ID SEMICOLON vars bloque','rose',5,'p_rose','rose.py',302),
  ('rose -> PROGRAM ID SEMICOLON bloque','rose',4,'p_rose','rose.py',303),
  ('bloque -> LEFTBRACKET b RIGHTBRACKET','bloque',3,'p_bloque','rose.py',310),
  ('b -> estatuto b','b',2,'p_b','rose.py',314),
  ('b -> empty','b',1,'p_b','rose.py',315),
  ('estatuto -> asignacion','estatuto',1,'p_estatuto','rose.py',320),
  ('estatuto -> condicion','estatuto',1,'p_estatuto','rose.py',321),
  ('estatuto -> escritura','estatuto',1,'p_estatuto','rose.py',322),
  ('vars -> GLOBALS c','vars',2,'p_vars','rose.py',327),
  ('c -> ID COMMA c','c',3,'p_c','rose.py',333),
  ('c -> ID COLON tipo SEMICOLON c','c',5,'p_c','rose.py',334),
  ('c -> ID COLON tipo SEMICOLON','c',4,'p_c','rose.py',335),
  ('tipo -> INT','tipo',1,'p_tipo','rose.py',340),
  ('tipo -> FLOAT','tipo',1,'p_tipo','rose.py',341),
  ('asignacion -> ID EQUALS expresion SEMICOLON','asignacion',4,'p_asignacion','rose.py',346),
  ('escritura -> PRINT LEFTPARENTHESIS e RIGHTPARENTHESIS SEMICOLON','escritura',5,'p_escritura','rose.py',351),
  ('e -> expresion PERIOD e','e',3,'p_e','rose.py',356),
  ('e -> CTES PERIOD e','e',3,'p_e','rose.py',357),
  ('e -> CTES','e',1,'p_e','rose.py',358),
  ('e -> expresion','e',1,'p_e','rose.py',359),
  ('e -> empty','e',1,'p_e','rose.py',360),
  ('expresion -> exp GT exp','expresion',3,'p_expresion','rose.py',366),
  ('expresion -> exp LT exp','expresion',3,'p_expresion','rose.py',367),
  ('expresion -> exp DIFFERENT exp','expresion',3,'p_expresion','rose.py',368),
  ('expresion -> exp','expresion',1,'p_expresion','rose.py',369),
  ('exp -> termino g','exp',2,'p_exp','rose.py',374),
  ('g -> PLUS termino g','g',3,'p_g','rose.py',380),
  ('g -> MINUS termino g','g',3,'p_g','rose.py',381),
  ('g -> empty','g',1,'p_g','rose.py',382),
  ('condicion -> IF LEFTPARENTHESIS expresion RIGHTPARENTHESIS bloque h SEMICOLON','condicion',7,'p_condicion','rose.py',387),
  ('h -> ELSE bloque','h',2,'p_h','rose.py',392),
  ('h -> empty','h',1,'p_h','rose.py',393),
  ('termino -> factor i','termino',2,'p_termino','rose.py',398),
  ('termino -> factor','termino',1,'p_termino','rose.py',399),
  ('i -> MULTIPLY factor i','i',3,'p_i','rose.py',404),
  ('i -> DIVIDE factor i','i',3,'p_i','rose.py',405),
  ('i -> MULTIPLY factor','i',2,'p_i','rose.py',406),
  ('i -> DIVIDE factor','i',2,'p_i','rose.py',407),
  ('factor -> LEFTPARENTHESIS expresion RIGHTPARENTHESIS','factor',3,'p_factor','rose.py',412),
  ('factor -> PLUS varcte','factor',2,'p_factor','rose.py',413),
  ('factor -> MINUS varcte','factor',2,'p_factor','rose.py',414),
  ('factor -> varcte','factor',1,'p_factor','rose.py',415),
  ('varcte -> ID','varcte',1,'p_varcte','rose.py',420),
  ('varcte -> CTEI','varcte',1,'p_varcte','rose.py',421),
  ('varcte -> CTEF','varcte',1,'p_varcte','rose.py',422),
  ('empty -> <empty>','empty',0,'p_empty','rose.py',427),
]
